...
public:
    ControlGimbal_dji() {
        ...
        sub_imu = nh.subscribe("dji_sdk/imu", 10, &ControlGimbal_dji::read_imu, this);
        ...
        inv_kinematic.open("ik_track_cotntrol_imu.txt");
    ...
    void setGimbalSpeed(int speedRoll, int speedPitch, int speedYaw) {
        ...
        gimbalSpeed.vector.z = yaw_offset - DEG2RAD(speedYaw); //deg
